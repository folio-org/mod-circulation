...
* Corrected permissions changed in MODCAL-136 (MODCAL-136)
* Upgrade to RMB v35.3.0 (CIRC-2163)
* Fix typo in StaffSlipsContext (CIRC-2134)
...
* Extending the loan representation with additional fields required for Due date receipt (CIRC-2144)
* Reverted CIRC-2100 PR and Rework for PrintEventDetail Pagination, searching and sorting (CIRC-2148)
...
* Error message - after Service point changed from "yes" to "no" as Pickup location (CIRC-1980)
* POST Api implementation (CIRC-2099)
* Added test case on enableRequestPrintDetailsSetting (CIRC-2096)
* Create API wrapping settings CRUD (CIRC-2111)
* Updating error response status and schema for request creation (CIRC-2104)
...
* Alternate loan period applied when multiple requests in fulfillment in progress (CIRC-2026)
* Revert adding useStubItem parameter to allowed-service-points (CIRC-2050)
* Add missing permissions (CIRC-2070)
* Set returnDate for lost loans (CIRC-2044)
* Add useStubItem parameter to allowed-service-points endpoint (CIRC-2050)
...
* Populate item info in multi-page loans API response (CIRC-2059)
