...
public class Clients {
  ...
  private Clients(OkapiHttpClient client, WebContext context) {
    try {
      ...
      manualBlocksStorageClient = createManualBlocksStorageClient(client,context);
    }
  ...
  public CollectionResourceClient manualBlocksStorageClient() {
    return manualBlocksStorageClient;
  }
  ...
  private static CollectionResourceClient createManualBlocksStorageClient(
    OkapiHttpClient client,
    WebContext context)
    throws MalformedURLException {
