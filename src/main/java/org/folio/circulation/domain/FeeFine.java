...
public class FeeFine {
  ...
  public static final String LOST_ITEM_FEE_ACTUAL_COST_TYPE = "Lost item fee (actual cost)";
  ...
  private static final Set<String> LOST_ITEM_FEE_TYPES =
    unmodifiableSet(hashSet(LOST_ITEM_FEE_TYPE, LOST_ITEM_FEE_ACTUAL_COST_TYPE, LOST_ITEM_PROCESSING_FEE_TYPE));
