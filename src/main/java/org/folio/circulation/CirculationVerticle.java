...
import org.folio.circulation.resources.OverrideItemLimitStrategy;
import org.folio.circulation.resources.PickSlipsResource;
import org.folio.circulation.resources.RegularCheckOutStrategy;
import org.folio.circulation.resources.RespectItemLimitStrategy;
...
public class CirculationVerticle extends AbstractVerticle {
  ...
  public void start(Promise<Void> startFuture) {
    ...
    new CheckOutByBarcodeResource("/circulation/check-out-by-barcode", client,
      new RegularCheckOutStrategy(), new RespectItemLimitStrategy()).register(router);
    new CheckOutByBarcodeResource("/circulation/override-check-out-by-barcode", client,
      new OverrideCheckOutStrategy(), new RespectItemLimitStrategy()).register(router);
    new CheckOutByBarcodeResource("/circulation/check-out-by-barcode-override-item-blocks", client,
      new RegularCheckOutStrategy(), new OverrideItemLimitStrategy()).register(router);
