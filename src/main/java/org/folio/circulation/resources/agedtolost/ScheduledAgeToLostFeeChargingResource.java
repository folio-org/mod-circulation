...
import org.folio.circulation.services.agedtolost.AssignLostFeesWhenAgedToLostService;
...
public class ScheduledAgeToLostFeeChargingResource extends Resource {
  ...
  private void scheduledAgeToLostFeeCharging(RoutingContext routingContext) {
    ...
    final AssignLostFeesWhenAgedToLostService chargingService =
      new AssignLostFeesWhenAgedToLostService(create(context, client));

    chargingService.processFeeAssigning()
