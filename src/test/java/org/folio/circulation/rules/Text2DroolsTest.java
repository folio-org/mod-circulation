...
class Text2DroolsTest {
  ...
  void headerFallbackPolicy() {
    ...
    Drools drools = new Drools("default", droolsText);
  ...
  @Test
  void twoPriorities() {
    Drools drools = new Drools("default", Text2Drools.convert(String.join("\n",
 ...
 @Test
  ...
  @Test
  void negation() {
    Drools drools = new Drools("default", Text2Drools.convert(HEADER + "m !dvd !music: l policy-a r no-hold n basic-notice o overdue i lost-item"));
    assertThat(drools.loanPolicy(params("dvd",       "regular", "student", "shelf"),
      createLocation(SECOND_INSTITUTION_ID, SECOND_LIBRARY_ID, SECOND_CAMPUS_ID)).getPolicyId(), is("no-loan"));
  ...
  @Test
  void negationSingle() {
    Drools drools = new Drools("default", Text2Drools.convert(HEADER + "m !dvd: l policy-a r no-hold n basic-notice o overdue i lost-item"));
    assertThat(drools.loanPolicy(params("dvd",       "regular", "student", "shelf"),
      createLocation(SECOND_INSTITUTION_ID, SECOND_LIBRARY_ID, SECOND_CAMPUS_ID)).getPolicyId(), is("no-loan"));
    assertThat(drools.loanPolicy(params("newspaper", "regular", "student", "shelf"),
      createLocation(SECOND_INSTITUTION_ID, SECOND_LIBRARY_ID, SECOND_CAMPUS_ID)).getPolicyId(), is("policy-a"));
  ...
  private void testLoanPolicies(String circulationRules, String [][] cases) {
    Drools drools = new Drools("default", Text2Drools.convert(circulationRules));
    for (String [] s : cases) {
