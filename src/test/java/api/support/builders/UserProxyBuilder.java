...
public class UserProxyBuilder implements Builder {
  ...
  public UserProxyBuilder(UUID id, String userId, String proxyUserId,
  ...
  public UserProxyBuilder withValidationFields(String expDate, String status, String userId, String proxyId) {
