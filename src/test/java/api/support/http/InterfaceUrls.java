...
public class InterfaceUrls {
  ...
  public static URL lostItemsRequiringActualCostsUrl(String subPath) {
    return circulationModuleUrl("/circulation/reports/lost-items-requiring-actual-cost-fees" + subPath);
  }
