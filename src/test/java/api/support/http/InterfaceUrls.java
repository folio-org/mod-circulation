...
public class InterfaceUrls {
  ...
  public static URL circulationItemsUrl(String subPath) {
  ...
  public static URL addInfoURL(String loanId) {
    return circulationModuleUrl(String.format("/circulation/loans/%s/add-info", loanId));
  }
