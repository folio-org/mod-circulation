...
public class CalendarExamples {
  ...
  public static final LocalDate FIRST_DAY_OPEN = new LocalDate(2021, 3, 29);
  public static final LocalDate SECOND_DAY_CLOSED = new LocalDate(2021, 3, 30);
  public static final LocalDate THIRD_DAY_CLOSED = new LocalDate(2021, 3, 31);
