...
public class CalendarExamples {
  ...
  public static final String ROLLOVER_SCENARIO_SERVICE_POINT_ID =
    "22211111-2f09-4bc9-8924-3734882d44a3";
  public static final String ROLLOVER_SCENARIO_NEXT_DAY_CLOSED_SERVICE_POINT_ID =
    "33311111-2f09-4bc9-8924-3734882d44a3";

  public static final String CASE_FRI_SAT_MON_DAY_ALL_SERVICE_POINT_ID =
    "11111111-2f09-4bc9-8924-3734882d44a3";
  public static final String CASE_FRI_SAT_MON_SERVICE_POINT_ID =
    "22222222-2f09-4bc9-8924-3734882d44a3";
  public static final String CASE_WED_THU_FRI_DAY_ALL_SERVICE_POINT_ID =
    "33333333-2f09-4bc9-8924-3734882d44a3";
  public static final String CASE_WED_THU_FRI_SERVICE_POINT_ID =
    "44444444-2f09-4bc9-8924-3734882d44a3";

  public static final String CASE_PREV_OPEN_AND_CURRENT_NEXT_CLOSED =
    "85346678-2f09-4bc9-8924-3734882d44a3";
  public static final String CASE_CALENDAR_IS_EMPTY_SERVICE_POINT_ID =
    "66655555-2f09-4bc9-8924-3734882d44a3";

  public static final String CASE_FIRST_DAY_OPEN_SECOND_CLOSED_THIRD_CLOSED =
    "6ab38b7a-c889-4839-a337-86aad0297d7c";
  public static final String CASE_FIRST_DAY_OPEN_SECOND_CLOSED_THIRD_OPEN =
    "6ab38b7a-c889-4839-a337-86aad0297d8d";
  public static final String CASE_MON_WED_FRI_OPEN_TUE_THU_CLOSED =
    "87291415-9f43-42ec-ba6b-d590f33509a0";

  static final String CASE_START_DATE_MONTHS_AGO_AND_END_DATE_THU =
    "12345698-2f09-4bc9-8924-3734882d44a3";

  static final String CASE_START_DATE_MONTHS_AGO_AND_END_DATE_WED =
    "77777777-2f09-4bc9-8924-3734882d44a3";
  static final String CASE_START_DATE_FRI_AND_END_DATE_NEXT_MONTHS =
    "88888888-2f09-4bc9-8924-3734882d44a3";

  public static final String CASE_CURRENT_IS_OPEN =
    "7a50ce1e-ce47-4841-a01f-fd771ff3da1b";
  public static final LocalDate CASE_CURRENT_IS_OPEN_PREV_DAY = LocalDate.of(
    2019,
    2,
    4
  );
  public static final LocalDate CASE_CURRENT_IS_OPEN_CURR_DAY = LocalDate.of(
    2019,
    2,
    5
  );
  public static final LocalDate CASE_CURRENT_IS_OPEN_NEXT_DAY = LocalDate.of(
    2019,
    2,
    6
  );
  public static final LocalDate CASE_CURRENT_IS_OPEN_IN_ONE_DAY = LocalDate.of(
    2019,
    2,
    7
  );
  ...
  public static final LocalDate CASE_FRI_SAT_MON_SERVICE_POINT_PREV_DAY = LocalDate.of(
    2019,
    2,
    1
  );
  public static final LocalDate CASE_FRI_SAT_MON_SERVICE_POINT_CURR_DAY = LocalDate.of(
    2019,
    2,
    2
  );
  public static final LocalDate CASE_FRI_SAT_MON_SERVICE_POINT_NEXT_DAY = LocalDate.of(
    2019,
    2,
    4
  );

  public static final LocalDate CASE_FRI_SAT_MON_DAY_ALL_PREV_DATE = LocalDate.of(
    2018,
    12,
    14
  );
  public static final LocalDate CASE_FRI_SAT_MON_DAY_ALL_CURRENT_DATE = LocalDate.of(
    2018,
    12,
    15
  );
  public static final LocalDate CASE_FRI_SAT_MON_DAY_ALL_NEXT_DATE = LocalDate.of(
    2018,
    12,
    17
  );
    ...
    fakeOpeningPeriods.put(
      ...
      new OpeningDayPeriodBuilder(
        ...
        new AdjacentOpeningDays(
          ...
          new OpeningDay(
            new ArrayList<>(),
            CASE_FRI_SAT_MON_DAY_ALL_PREV_DATE,
            true,
            true
          ),
          // current day
          new OpeningDay(
            new ArrayList<>(),
            CASE_FRI_SAT_MON_DAY_ALL_CURRENT_DATE,
            false,
            false
          ),
          // next day
          new OpeningDay(
            new ArrayList<>(),
            CASE_FRI_SAT_MON_DAY_ALL_NEXT_DATE,
            true,
            true
          )
        )
    ...
    fakeOpeningPeriods.put(
      ...
      new OpeningDayPeriodBuilder(
        ...
        new AdjacentOpeningDays(
          ...
          new OpeningDay(
            new ArrayList<>(),
            CASE_FRI_SAT_MON_SERVICE_POINT_CURR_DAY,
            false,
            false
          ),
          // next day
        ...
        new AdjacentOpeningDays(
          ...
          new OpeningDay(
            Collections.singletonList(
              new OpeningHour(
                LocalTime.MIDNIGHT,
                LocalTime.MIDNIGHT.plusHours(3)
              )
            ),
            CASE_CURRENT_IS_OPEN_CURR_DAY,
            false,
    ...
    fakeOpeningPeriods.put(
      ...
      new OpeningDayPeriodBuilder(
        ...
        new AdjacentOpeningDays(
          ...
          new OpeningDay(
            Collections.singletonList(
              new OpeningHour(START_TIME_FIRST_PERIOD, END_TIME_SECOND_PERIOD)
            ),
            CASE_CURRENT_IS_OPEN_PREV_DAY,
            false,
            true
  ...
  private static OpeningDayPeriodBuilder buildAllDayOpenCalenderResponse(
  ...
  public static CalendarBuilder getCalendarById(
    String serviceId,
    MultiMap queries
  ) {
    switch (serviceId) {
      ...
      case CASE_START_DATE_MONTHS_AGO_AND_END_DATE_THU:
        ...
        return new CalendarBuilder(
          CASE_START_DATE_MONTHS_AGO_AND_END_DATE_THU,
          startDate,
          endDate
        );
      case CASE_START_DATE_MONTHS_AGO_AND_END_DATE_WED:
        ZonedDateTime endDateWednesday = ZonedDateTime.of(
          WEDNESDAY_DATE,
          LocalTime.MIDNIGHT,
          UTC
        );
      ...
      case CASE_START_DATE_FRI_AND_END_DATE_NEXT_MONTHS:
        ZonedDateTime startDateFriday = ZonedDateTime.of(
          FRIDAY_DATE,
          LocalTime.MIDNIGHT,
          UTC
        );
      ...
      default:
        LocalDate requestedDate = LocalDate.parse(
          queries.get(REQUESTED_DATE_PARAM)
        );
        return new CalendarBuilder(
          buildAllDayOpenCalenderResponse(requestedDate, serviceId)
        );
    }
  }

  public static List<OpeningDay> getCurrentAndNextFakeOpeningDayByServId(
    String serviceId
  ) {
    OpeningDayPeriodBuilder periodBuilder = fakeOpeningPeriods.get(serviceId);
    return Arrays.asList(
      periodBuilder.getCurrentPeriod(),
      periodBuilder.getLastPeriod()
    );
  }
