...
public class AllowedServicePointsAPITests extends APITests {
  ...
  @CsvSource(value = {
    // null checks
    "NULL,                                  7341b1d6-a6a7-41ec-8653-00b819a70a30, NULL",
  ...
  void getFailsWithBadRequest(String requesterId, String instanceId, String itemId) {
    get(requesterId, instanceId, itemId, HttpStatus.SC_BAD_REQUEST);
  }
